...
def index():
    ...
    emform = EmptyForm()
    return render_template("index.html", title="Course List", classes=classes, eform =emform)
...
def display_profile():
     emform = EmptyForm()
     return render_template('display_profile.html', title='Display Profile',student = current_user,eform = emform)
